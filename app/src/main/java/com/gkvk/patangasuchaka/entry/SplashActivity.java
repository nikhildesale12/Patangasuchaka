...
import com.gkvk.R;
import com.gkvk.patangasuchaka.main.DashboardActivity;
...
public class SplashActivity extends AwesomeSplash {
    ...
    //if you need to start some serbuttonModulevices do it in initSplash()!
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.butterflysplash); //or any other drawable
       ...
       // configSplash.setPathSplash(SyncStateContract.Constants.DROID_LOGO); //set path String
        ...
        //Customize Title
        configSplash.setTitleSplash("PATANGA SUCHAKA"); //change your app name here
    ...
    public void animationsFinished() {
        //Toast.makeText(SplashActivity.this, "Go to DashboardActivity now!!", Toast.LENGTH_SHORT).show();
